package com.TwitterScrapper.controller;

import com.TwitterScrapper.repository.TweetRepository;
import com.TwitterScrapper.model.Tweet;
import com.TwitterScrapper.exception.ResourceNotFoundException;
...
public class TweetController {
    ...
    @GetMapping("/tweet")
    public List<Tweet> getAllTweets(@RequestParam(value = "tag", required = false) String tag) {
        if(tag != null){
